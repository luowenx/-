...
NSString const *badgeOfsetXKey  = @"badgeOfsetXKey";
NSString const *badgeOfsetYKey  = @"badgeOfsetYKey";
...
-(CGFloat)badgeOffsetX{
    NSNumber * number = objc_getAssociatedObject(self, &badgeOfsetXKey);
...
-(void)setBadgeOffsetX:(CGFloat)badgeOffsetX{
    ...
    objc_setAssociatedObject(self, &badgeOfsetXKey, number, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    
    self.badgeOriginX = self.badgeOriginX + badgeOffsetX;
}
-(CGFloat)badgeOffsetY{
    NSNumber * number = objc_getAssociatedObject(self, &badgeOfsetYKey);
...
-(void)setBadgeOffsetY:(CGFloat)badgeOffsetY{
    ...
    objc_setAssociatedObject(self, &badgeOfsetYKey, number, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    
    self.badgeOriginY = self.badgeOriginY + badgeOffsetY;
}
